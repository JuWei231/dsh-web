...
- **Original flat-illustration artwork** generated programmatically by `docs/archive/blue-throated-bee-eater-pet/gen-pet.py`: Pillow Catmull-Rom spline shapes drawn at 4x supersampling, anatomy anchored on the Blue-throated Bee-eater (chestnut crown cap, black eye-mask band, azure throat patch, teal-green body, azure tail streamers, long curved dark beak), palette taken from the skin tokens (#2b87d8 / #41a3e8 / #b26a3b / #0c2029 / #eef6f9) with a dedicated green-teal for the plumage.
